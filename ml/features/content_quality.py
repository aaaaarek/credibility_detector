...
HIGH_RISK_PATTERNS = {
    ...
    "guaranteed_profit": [
        r"\b(gwarantowan\w+|guaranteed|pewn\w+)\b",
        r"\b(krypto|crypto|bitcoin|inwestycj\w+|zysk|profit|return)\b",
    ],
    "hidden_truth": [
    ...
    "election_fraud": [
        r"\b(wybor\w*|glosowan\w*|election\w*|vote\w*)\b",
        r"\b(sfalszowan\w+|fraud|stolen|rigged)\b",
    ],
    "fabricated_crisis": [
        r"\b(fake|hoax|sfalszowan\w+|zmyslon\w+)\b",
        r"\b(pandemi\w+|wojn\w+|crisis|pandemic|war)\b",
    ],
    "secret_investment_scheme": [
        r"\b(tajny\w+|secret|ukrywan\w+|hidden)\b",
        r"\b(inwestycj\w+|investment|crypto|krypto|bitcoin)\b",
    ],
}
